export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxa439078f197677bf",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "6817f25190c75cb400be6282dbbe1e57",
  ...
  USERS: [
    {
      ...
      id: "oNZV75jyzE6P8MdUPUNtIlrZeUEY",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "oNZV75mVyzNCNy4y0tWyfJEA7hW0",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "漯河"
  ...
  CALLBACK_TEMPLATE_ID: "oNZV75jyzE6P8MdUPUNtIlrZeUEY",
